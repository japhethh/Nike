...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start flex-wrap max-lg:flex-col gap-3">
            ...
            <div className="" key={section}>
              ...
              <ul>
                {section.links.map((links) => (
                  <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray" key={links.name}>
